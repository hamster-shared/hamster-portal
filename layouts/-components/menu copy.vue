    ...
    <div class="">
      <div v-for="item in navigationList" :key="item.name">
        ...
        <div v-for="val in item.data">
          <div
            class="menu-nav-item-title text-[18px] text-[#051336] font-semibold cursor-pointer hover:text-[#3B4DF0] w-[170px]">
            {{
              val.name }}</div>
        </div>
      </div>
...
const navigationList = ref([
  { name: 'Smart Contract', data: [{ name: 'Development', type: 'smartContractDevelopment' }, { name: 'Secure Code', type: 'smartContractSecureCode' }, { name: 'Secure Deploy', type: 'smartContractSecureDeploy' }] },
  { name: 'Front End', data: [{ name: 'Development', type: 'frontEndDevelopment' }, { name: 'Secure Code', type: 'frontEndSecureCode' }, { name: 'Fast Deploy', type: 'frontEndFastDeploy' }] },
  { name: 'Node', data: [{ name: 'Development', type: 'nodeDevelopment' }, { name: 'Secure Deploy', type: 'nodeSecureDeploy' }] },
  { name: 'Market', data: [{ name: 'Template Market', type: 'marketTemplateMarket' }, { name: 'Middleware', type: 'marketMiddleware' }] },
])
